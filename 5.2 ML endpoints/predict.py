...
# we will get it as a dict, we use something like user_input.model_dump() in main.py to convert json into dict.
# and this will return a floting value the actual predicted value.
